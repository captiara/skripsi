        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('pasiens.update', ['id' => $pasien->id]) }}">
                        ...
                        <div class="form-group{{ $errors->has('alamat') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Alamat" type="text" class="form-control" name="alamat" value="{{ $pasien->alamat }}" required>
                        ...
                        <div class="form-group{{ $errors->has('tempatLahir') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tempatLahir" type="text" class="form-control" name="tempatLahir" value="{{ $pasien->tempatLahir }}" required>
                        ...
                        <div class="form-group{{ $errors->has('tanggalLahir') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tanggalLahir" type="text" class="form-control" name="tanggalLahir" value="{{ $pasien->tanggalLahir}}" required>
