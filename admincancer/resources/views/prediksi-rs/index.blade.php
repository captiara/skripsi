          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                ...
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" >Jumlah Anak Laki-laki </th>
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" >Menggunakan IUD</th>
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" >Kanker Prediksi </th>
            ...
            @foreach ($prediksis as $prediksi)
                <tr role="row" class="odd">
                  ...
                  <td class="hidden-xs">{{$prediksi->Jumlah_Anak_LK }} </td>
                  <td class="hidden-xs"> {{ $prediksi-> Sekarang_Menggunakan_IUD }} </td> 
                  <td class="hidden-xs"> <p> {{$prediksi -> CLASS }} </p> </td> 
                  <td>
            ...
            <tfoot>
              <tr>
                ...
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" >Jumlah Anak Laki-laki </th>
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" >Menggunakan IUD</th>
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" >Prediksi Kanker</th>
                <th tabindex="0" aria-contr ls="example2" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending">Action</th>
              </tr>
              </tr>
            </tfoot>
          </table>
